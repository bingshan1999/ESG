...
def create_prompt(title, content):
    return [
        ...
        f"""
            ...
            Step 2: Based on Step 1, extract the original sentences from the article that relates the Environmental Aspects. Return the sentences in an array.
            Environmental Array:

            Step 3: Identify and explain any Social (S) aspects mentioned in the context. Try to retrain the original sentences from the article.
            Social Aspects:

            Step 4: Based on Step 3, extract the original sentences from the article that relates the Social Aspects. Return the sentences in an array.
            Social Array:
            
            Step 5: Identify and explain any Governance (G) aspects mentioned in the context. Try to retrain the original sentences from the article.
            Governance Aspects:

            Step 6: Based on Step 5, extract the original sentences from the article that relates the Governance Aspects. Return the sentences in an array.
            Governance Array:
        """,
        
        # 6. Lesser steps (combining aspect and array)
        f"""
            Article Title: {title}
            Article Context: {content}
